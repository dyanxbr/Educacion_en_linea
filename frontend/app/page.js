...
export default function TestImagenCloudinary() {
  ...
  const subirImagen = async () => {
    ...
    if (!token.trim()) return setError("Pega tu token JWT primero");
  ...
  return (
    <div style={s.page}>
      {/* Header */}
      <div style={s.header}>
        <div style={s.badge}>☁️ Test Cloudinary</div>
        <h1 style={s.titulo}>Subida de Imagen</h1>
      ...
      <div style={s.card}>
        ...
        {/* Token */}
        <div style={s.campo}>
          <label style={s.label}>🔑 Token JWT</label>
          <textarea
            style={s.textarea}
            placeholder="Pega aquí tu Bearer token del login..."
            value={token}
        ...
        {/* Dropzone */}
        <div style={s.campo}>
          <label style={s.label}>🖼️ Seleccionar imagen</label>
        ...
        <button
          ...
          disabled={cargando}
        >
          {cargando ? "⏳ Subiendo a Cloudinary..." : "🚀 Subir imagen"}
        </button>
            ...
            {respuesta.imagen_url && (
              <>
                <img
                  ...
                  alt="imagen subida"
                  style={s.imagenSubida}
                />
                <p style={s.urlLabel}>URL en Cloudinary:</p>
                <a
                  href={respuesta.imagen_url}
                  target="_blank"
        ...
        <div style={s.infoBox}>
          ...
          <div style={s.infoFila}>
            ...
            <code style={{ ...s.infoCode, color: "#60a5fa" }}>PUT</code>
          </div>
          <div style={s.infoFila}>
            <span style={s.infoKey}>URL</span>
            <code style={s.infoCode}>{API}/usuarios/imagen</code>
          </div>
          <div style={s.infoFila}>
            <span style={s.infoKey}>Header</span>
            <code style={s.infoCode}>Authorization: Bearer TOKEN</code>
          </div>
          <div style={s.infoFila}>
            <span style={s.infoKey}>Body</span>
            <code style={s.infoCode}>form-data → imagen: archivo</code>
          </div>
        </div>
